...
class Test200SmartFullIdevice020(CaseMW):
    ...
    Expected results:
        1. Ip and station name show correctly in the network topology, there is a  "Catalog" tree with correct
           module in the right.
    ...
    def process(self):
        ...
        self.logger.info('1. Ip and station name show correctly in the network topology, there is a  "Catalog" '
                         'tree with correct module in the right.')
