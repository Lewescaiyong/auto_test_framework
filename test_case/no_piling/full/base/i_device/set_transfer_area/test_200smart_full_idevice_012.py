...
class Test200SmartFullIdevice012(CaseMW):
    ...
    Expected results:
        1. The display page include "Transfer Areas", there is no transfer area by default.
           the title in first row of transfer area tale is correct.
    Priority: H
    Author: Cai, Yong
    ...
    def process(self):
        ...
        self.logger.info('1. The display page include "Transfer Areas", there is no transfer area by default.'
                         'the title in first row of transfer area tale is correct.')
