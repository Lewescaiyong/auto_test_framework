...
class Test200SmartSanityUi006(CaseMWGUI):
    """Reset to factory defaults
    No.: test_200smart_sanity_ui_006
    Preconditions:
    ...
    Step actions:
        ...
        2. Select Reset to factory defaults in clear popup(PLC-Modify-Clear), and click Clear;
        3. Upload all to a new project; ;
    Expected results:
        1. Download successful;
        2. Clear successful;
        3. Upload successful, all blocks is cleared, all user memory is reset to initial powerup state, all special memory is reset to initial values, ip and station name and day clock is not cleared;
    Priority: H
    Author: Wang, Xing Yu
    ...
    def prepare(self):
        ...
        ChangeInfo: Wang, Xing Yu 2019-10-30 create
        """
        super(Test200SmartSanityUi006, self).prepare()
    ...
    def process(self):
        ...
        ChangeInfo: Wang, Xing Yu 2019-10-30 create
        """
        super(Test200SmartSanityUi006, self).process()
        ...
        # choose 'Reset to factory default' option
        time.sleep(0.5)
        set_check_box(clear_win, OPT_RESET, index=3)
    ...
    def cleanup(self):
        ...
        ChangeInfo: Wang, Xing Yu 2019-10-30 create
        """
        super(Test200SmartSanityUi006, self).cleanup()
