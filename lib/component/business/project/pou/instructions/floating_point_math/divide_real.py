...
class DivideReal(FloatingPointMathBase):
    ...
    def __init__(self, own_software, params=None):
        super(DivideReal, self).__init__(own_software, params)
    ...
    def properties_config(self):
        ...
        public = super(DivideReal, self).properties_config
        local = {'id': 333, 'locations': [{'row_add': 1, 'col_add': 0, 'id': 0}, {'row_add': 1, 'col_add': 0, 'id': 1},
