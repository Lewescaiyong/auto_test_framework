...
class Test200SmartFullIdevice043(CaseMW):
    """I-Device  dcp
    No.: test_200smart_full_idevice_043
    Preconditions:
        1. Open Micro/WIN V2.5;
        2. Plc role is "I-Device";
    Step actions:
        1. Check "Paraneter assignment..." and "Obtain IP address by other services", add 8 transfer areas, generate and download to CPU;
    ...
    def prepare(self):
        ...
        ChangeInfo: Cai, Yong 2019-12-13 create
        """
        super(Test200SmartFullIdevice043, self).prepare()
    ...
    def process(self):
        ...
        ChangeInfo: Cai, Yong 2019-12-13 create
        """
        super(Test200SmartFullIdevice043, self).process()

        self.logger.info('Step actions:')
        self.logger.info('1. Check "Paraneter assignment..." and "Obtain IP address by other services", add 8 transfer areas, generate and download to CPU;')
    ...
    def cleanup(self):
        ...
        ChangeInfo: Cai, Yong 2019-12-13 create
        """
        super(Test200SmartFullIdevice043, self).cleanup()
