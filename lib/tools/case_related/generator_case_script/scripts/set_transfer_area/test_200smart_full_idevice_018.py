...
class Test200SmartFullIdevice018(CaseMW):
    ...
    Expected results:
        1. Modify successful;
        2. Modify successful;
        3. Modify failed, the address has red under line, When the mouse is over the address, there are reasonable prompts;
    Priority: H
    Author: Cai, Yong
    ...
    def prepare(self):
        ...
        self.logger.info('2. In PN wizard, select plc role is "I-Device", click "Next" and add one transfer area, address is 1152;')
    ...
    def process(self):
        ...
        self.logger.info('3. Modify failed, the address has red under line, When the mouse is over the address, there are reasonable prompts;')
