...
class Test200SmartFullIdevice054(CaseMW):
    """From none to I-device with L-L IO
    No.: test_200smart_full_idevice_054
    Preconditions:
    ...
    def prepare(self):
        ...
        ChangeInfo: Cai, Yong 2019-12-13 create
        """
        super(Test200SmartFullIdevice054, self).prepare()
    ...
    def process(self):
        ...
        ChangeInfo: Cai, Yong 2019-12-13 create
        """
        super(Test200SmartFullIdevice054, self).process()
    ...
    def cleanup(self):
        ...
        ChangeInfo: Cai, Yong 2019-12-13 create
        """
        super(Test200SmartFullIdevice054, self).cleanup()
