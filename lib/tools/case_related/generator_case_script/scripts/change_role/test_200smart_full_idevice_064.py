...
class Test200SmartFullIdevice064(CaseMW):
    """From I-device with L-L IO to controller
    No.: test_200smart_full_idevice_064
    Preconditions:
    ...
    def prepare(self):
        ...
        ChangeInfo: Cai, Yong 2019-12-13 create
        """
        super(Test200SmartFullIdevice064, self).prepare()
    ...
    def process(self):
        ...
        ChangeInfo: Cai, Yong 2019-12-13 create
        """
        super(Test200SmartFullIdevice064, self).process()
    ...
    def cleanup(self):
        ...
        ChangeInfo: Cai, Yong 2019-12-13 create
        """
        super(Test200SmartFullIdevice064, self).cleanup()
