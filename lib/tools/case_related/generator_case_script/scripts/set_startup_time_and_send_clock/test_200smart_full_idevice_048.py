...
class Test200SmartFullIdevice048(CaseMW):
    """Startup time--i-device without L-L device
    No.: test_200smart_full_idevice_048
    Preconditions:
        1. Open Micro/WIN V2.5;
        2. Set startup mode to "RUN";
        3. Plc role is "I-Device";
    Step actions:
    ...
    def prepare(self):
        ...
        ChangeInfo: Cai, Yong 2019-12-13 create
        """
        super(Test200SmartFullIdevice048, self).prepare()

        self.logger.info('Preconditions:')
        self.logger.info('1. Open Micro/WIN V2.5;')
        self.logger.info('2. Set startup mode to "RUN";')
        self.logger.info('3. Plc role is "I-Device";')
    ...
    def process(self):
        ...
        ChangeInfo: Cai, Yong 2019-12-13 create
        """
        super(Test200SmartFullIdevice048, self).process()
    ...
    def cleanup(self):
        ...
        ChangeInfo: Cai, Yong 2019-12-13 create
        """
        super(Test200SmartFullIdevice048, self).cleanup()
