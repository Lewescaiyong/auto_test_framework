...
class Test200SmartFullIdevice076(CaseMW):
    """Controller +  i-device (DCP)(catalog configuration)
                     + 7 io-device
    No.: test_200smart_full_idevice_076
    Preconditions:
    ...
    Step actions:
        ...
        3. Another PLC, select role is controller,add idevice in step1 by catalog configuration, set ip,  then add 7 io-device, generate and download;
    ...
    def prepare(self):
        ...
        ChangeInfo: Cai, Yong 2019-12-13 create
        """
        super(Test200SmartFullIdevice076, self).prepare()
    ...
    def process(self):
        ...
        ChangeInfo: Cai, Yong 2019-12-13 create
        """
        super(Test200SmartFullIdevice076, self).process()
        ...
        self.logger.info('3. Another PLC, select role is controller,add idevice in step1 by catalog configuration, set ip,  then add 7 io-device, generate and download;')
    ...
    def cleanup(self):
        ...
        ChangeInfo: Cai, Yong 2019-12-13 create
        """
        super(Test200SmartFullIdevice076, self).cleanup()
