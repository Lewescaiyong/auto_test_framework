...
class Test200SmartFullIdevice067(CaseMW):
    """Controller + io-device
    No.: test_200smart_full_idevice_067
    Preconditions:
        1. Open Micro/WIN V2.5;
        2. Plc role is "Controller";
    Step actions:
        1. Add an io-device, generate and download;
    ...
    def prepare(self):
        ...
        ChangeInfo: Cai, Yong 2019-12-13 create
        """
        super(Test200SmartFullIdevice067, self).prepare()
    ...
    def process(self):
        ...
        ChangeInfo: Cai, Yong 2019-12-13 create
        """
        super(Test200SmartFullIdevice067, self).process()

        self.logger.info('Step actions:')
        self.logger.info('1. Add an io-device, generate and download;')
    ...
    def cleanup(self):
        ...
        ChangeInfo: Cai, Yong 2019-12-13 create
        """
        super(Test200SmartFullIdevice067, self).cleanup()
