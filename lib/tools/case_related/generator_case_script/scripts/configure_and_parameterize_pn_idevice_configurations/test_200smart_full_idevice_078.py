...
class Test200SmartFullIdevice078(CaseMW):
    """Controller + i-device(with low level system)
                      + io-device
    No.: test_200smart_full_idevice_078
    Preconditions:
    ...
    def prepare(self):
        ...
        ChangeInfo: Cai, Yong 2019-12-13 create
        """
        super(Test200SmartFullIdevice078, self).prepare()
    ...
    def process(self):
        ...
        ChangeInfo: Cai, Yong 2019-12-13 create
        """
        super(Test200SmartFullIdevice078, self).process()
    ...
    def cleanup(self):
        ...
        ChangeInfo: Cai, Yong 2019-12-13 create
        """
        super(Test200SmartFullIdevice078, self).cleanup()
